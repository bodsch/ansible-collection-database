...
class MariaDBRootPassword(object):
    ...
    def __init__(self, module):
        ...
        self.dba_bind_address = module.params.get(
            "dba_bind_address"
        )  # TODO: rename to bind_address
        self.dba_config_directory = module.params.get("dba_config_directory")
        self.mycnf_file = module.params.get("mycnf_file")

        self.checksum_file = os.path.join(
            self.dba_config_directory, ".rootpw_configured"
        )
    ...
    def run(self):
        ...
        if old_checksum == new_checksum:
            return dict(changed=False, msg="password was not changed")
        ...
        return dict(changed=True, msg="password was successful set")
...
def main():
    ...
    specs = dict(
        ...
        dba_bind_address=dict(required=False, type="str"),
