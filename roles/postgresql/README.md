# Ansible Role: `bodsch.database.postgresql`


Installs and configure a postgres on varoius linux systems.
...
#   data_directory: "{{ postgresql_data_dir }}"         # use data in another directory     'ConfigDir'
#   hba_file: ""                                        # host-based authentication file    'ConfigDir/pg_hba.conf'
#   ident_file: ""                                      # ident configuration file          'ConfigDir/pg_ident.conf'
